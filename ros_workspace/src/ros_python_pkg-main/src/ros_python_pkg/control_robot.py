...
if __name__ == '__main__':
    ...
    orientation = quaternion_from_euler(x=0.0, y=90.0, z=0.0) # Pasar de euler a quaterniones
    pose = Pose(position = Point(x = 0.0, y=0.0, z=0.0), orientation=orientation) # Guardar pose
    ...
    pose_origen = control.pose_actual()
    pose = copy.deepcopy(pose_origen)
    pose.z += 0.1
    ...
    #control.mover_pinza(10.0, 40.0)
    #control.mover_pinza(0.0, 4.0)
    '''